      ...
      <div className="p-6">
        ...
        <div className="mt-8 flex justify-end border-t border-slate-100 pt-6">
          <button
            ...
            disabled={saving}
            className="flex items-center gap-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 hover:from-cyan-500 hover:to-blue-500 transition-all disabled:opacity-70"
          >
            {saving ? (
